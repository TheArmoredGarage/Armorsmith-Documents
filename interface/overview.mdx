...
<CardGroup cols={2}>
  ...
  <Card title="Workspaces Panel" icon="table-list" href="/interface/property-grid">
...
**Start with the avatar.** Before attaching any 3D models, use **Avatar → Edit Avatar** or select the <img src="/images/edit-avatar-button.png" alt="Edit Avatar toolbar button" noZoom style={{ display: "inline-block", height: "1.25em", verticalAlign: "middle" }} /> button on the toolbar to enter your measurements. The entire template-generation system scales to that avatar, so accurate measurements are critical.
