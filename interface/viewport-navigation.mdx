...
export const ToolInfo = ({ icon, alt, children }) => (
  <div
    style={{
      display: "flex",
...
<AccordionGroup>
  ...
  <Accordion title="Translate">
    <ToolInfo icon="/images/buttons/move-option_.png" alt="Translate button">
  Moves the selected objects using the translation gizmo.
</ToolInfo>
  </Accordion>
