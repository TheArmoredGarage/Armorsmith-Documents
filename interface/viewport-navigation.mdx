...
<AccordionGroup>
  ...
  <Accordion title="Edit Pose" icon="person-running" iconstyle="solid">
    <div style={{display:"flex", alignItems:"center", gap:"16px"}}>
  ...
  <Accordion title="Fit Checker" icon="shirt" iconstyle="solid">
    <ToolInfo icon="/images/icons/shirt-solid.png" name="Fit Checker">
  Moves the selected objects using the translation gizmo. Objects can be
  repositioned along the X, Y, and Z axes.
</ToolInfo>
  </Accordion>
