...
<Accordion title="Open" icon="{byPrefixAndName.far['folder']}">
</Accordion>
...
<Accordion title="Save" icon="floppy-disk">
  ...
  <div>
    Moves the selected objects within the Work Area.

    Use the translation gizmo or enter precise values in the Transform Panel.
  </div>
</div>
</Accordion>
