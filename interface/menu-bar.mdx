...
<Accordion title="Export">
  Model Exports your project or generated templates to an output format — for example, a printable PDF pattern sheet. Use this when you are ready to produce physical construction templates from your design. Unfold
</Accordion>
